    ...
    return (
      <div className='text-center py-12'>
        ...
        <p className='text-gray-600 font-medium mb-1'>
          {ratingFilter ? `Không có đánh giá ${ratingFilter} sao nào` : 'Chưa có đánh giá nào cho sản phẩm này'}
        </p>
        ...
        return (
          <div
            ...
            className={`review-item p-5 rounded-xl border transition-all hover:shadow-md ${
              !review.is_active && isOwner ? 'bg-gray-50 border-gray-300 opacity-60' : 'border-gray-200 bg-white'
            }`}
          >
            ...
            {review.replies && review.replies.length > 0 && (
              <div className='replies-container mt-4 ml-12 space-y-3 border-l-2 border-blue-200 pl-4'>
                {review.replies.map((reply) => (
                  <div key={reply._id} className='reply-item p-4 rounded-lg bg-blue-50 border border-blue-100'>
                    <div className='flex items-start gap-3'>
                      ...
                      <div className='flex-1 min-w-0'>
                        ...
                        {reply.comment && (
                          <p className='text-gray-700 text-sm leading-relaxed whitespace-pre-wrap'>{reply.comment}</p>
                        )}
