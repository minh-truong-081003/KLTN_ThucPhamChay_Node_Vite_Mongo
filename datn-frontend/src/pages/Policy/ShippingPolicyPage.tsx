        ...
        <div className='max-w-[1140px] mx-auto'>
            ...
            <div className='space-y-6'>
              <div className='flex items-start'>
                ...
                <div>
                  ...
                  <p className='text-gray-700'>Nhân viên gọi điện xác nhận đơn hàng và thời gian giao hàng trong vòng 30 phút</p>
                </div>
              </div>
              ...
              <div className='flex items-start'>
                ...
                <div>
                  ...
                  <p className='text-gray-700'>Sản phẩm đông lạnh được đóng gói trong thùng xốp kèm gel giữ lạnh, đảm bảo nhiệt độ -18°C</p>
                </div>
              </div>
          ...
          <div className='bg-yellow-50 border-l-4 border-[#d3b673] rounded-lg p-6'>
            ...
            <ul className='space-y-2 text-gray-700'>
              ...
              <li>• Liên hệ ngay <strong className='text-[#d3b673]'>1900.111.111</strong> nếu phát hiện sai sót</li>
